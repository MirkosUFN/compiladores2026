...
int main() {
    ...
    while(fgets(linha, sizeof(linha), f_in)) {
        ...
        while(palavra) {
            // Calcula a coluna exata rastreando a palavra na linha original
            ...
            // Impressão alinhada das 5 colunas
