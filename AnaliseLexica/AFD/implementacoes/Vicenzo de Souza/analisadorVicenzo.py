...
if __name__ == "__main__":
    ...
    # 1. Cria o arquivo de configuração, agora mandando o Q4 (sinal) para o Q3 (FRAC)
    if not os.path.exists(arquivo_config) or True: # Forcei a recriação para aplicar a nova regra
        conteudo_config = """Q0 Q1 Q2 Q3 Q4 Q5
